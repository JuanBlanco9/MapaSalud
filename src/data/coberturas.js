...
export const pmo = {
  ...
  tratamientos: [
    ...
    },
    {
      ...
      cobertura: "100%",
      autorizacionPrevia: true,
      nota: "Convencional, conformada 3D, IMRT. Protonterapia y radiocirugia estereotaxica: cobertura discutida, frecuente amparo.",
    },
    {
    ...
    },
    {
      ...
      cobertura: "Variable",
      autorizacionPrevia: true,
      nota: "26 drogas en Res 3377/2022: trastuzumab, pertuzumab, bevacizumab, cetuximab, panitumumab, rituximab, erlotinib, gefitinib, afatinib, alectinib, imatinib, nilotinib, dasatinib, ibrutinib, palbociclib, ribociclib, abemaciclib, dabrafenib, trametinib, y mas. Osimertinib, T-DXd y sacituzumab requieren amparo.",
    },
    {
      tipo: "Inmunoterapia",
      cobertura: "Variable",
      autorizacionPrevia: true,
      nota: "Pembrolizumab y nivolumab en Res 3377/2022. Atezolizumab en IPC PBA pero no en vademecum nacional. Ipilimumab, durvalumab, dostarlimab: requieren amparo. Nivolumab subcutaneo aprobado ANMAT 2026.",
    },
    {
      tipo: "Hormonoterapia",
      cobertura: "100%",
      autorizacionPrevia: false,
      nota: "12 drogas en Res 3377/2022: tamoxifeno, anastrozol, letrozol, exemestano, fulvestrant, abiraterona, enzalutamida, goserelina, leuprolida, triptorelina, bicalutamida, flutamida. Apalutamida requiere reclamo.",
    },
    {
  ...
  estudios: [
    ...
    },
    {
      ...
      cobertura: "100%",
      autorizacionPrevia: true,
      nota: "Requiere justificacion medica. Obligatorio cubrir, aunque algunas OS demoran.",
    },
    {
    ...
    },
    {
      ...
      cobertura: "Discutida",
      autorizacionPrevia: true,
      nota: "Tests genomicos para mama temprano. Algunas OS cubren, otras requieren amparo. Se procesan en USA.",
    },
    {
      nombre: "Panel genomico amplio (NGS)",
      cobertura: "Parcial / Discutida",
      autorizacionPrevia: true,
      nota: "No incluido formalmente en PMO. Frecuente motivo de amparo. Jurisprudencia favorable cuando el oncologo fundamenta necesidad.",
    },
    {
      nombre: "Biopsia liquida (ctDNA)",
      cobertura: "No incluida en PMO",
      autorizacionPrevia: true,
      nota: "Requiere amparo en casi todos los casos. Precio aprox USD 1500-3000.",
    },
    {
      nombre: "PET PSMA (prostata)",
      cobertura: "Discutida",
      autorizacionPrevia: true,
      nota: "Cobertura variable. Mas disponible en CABA y GBA.",
    },
  ],
};
